...
+ (BOOL)renderSkiaView:(UIView *)skiaUIView
  ...
  CVReturn result = CVMetalTextureCacheCreateTextureFromImage(kCFAllocatorDefault, cache, pixelBuffer, nil,
  ...
  GrBackendTexture backendTexture = GrBackendTextures::MakeMtl(width, height, skgpu::Mipmapped::kNo, textureInfo);

  auto surface = SkSurfaces::WrapBackendTexture(grContext, backendTexture, kTopLeft_GrSurfaceOrigin, 0,
