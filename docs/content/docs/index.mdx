...
It supports Skia! This enables many more use cases - as far as I know, no other library can record Skia content to video. The Skia pipeline is zero-copy and works with all Skia renderers (Canvas, OpenGL, Metal) since it captures directly from the GPU.
